...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/kubernetes/handbook/flexsearch.min.js');loadScript('/kubernetes/handbook/en.search-data.min.f9f9fabdbac8062051f3bd53bf59e278cecbf9cf1a038ee903625c3853c0c38f.js',function(){input.required=false;search();});}
